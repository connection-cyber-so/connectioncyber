...
test('preflight verifica as treze RPCs persistentes (7 M18 + 6 M20/M21-G1)',()=>assert.equal(new Set(sql.match(/erp_command_[a-z_]+_v1\(uuid,text,text,jsonb\)/g)).size,13));
