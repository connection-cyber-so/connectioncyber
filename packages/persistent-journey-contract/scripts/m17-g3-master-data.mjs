...
const item = await app.execute({ host, command: syntheticCommand('catalog.item.create', 2, { marker: 'SYNTHETIC-MASTER-DATA', kind: 'product', code: 'SYNTHETIC-001', name: 'SYNTHETIC PRODUCT', trackInventory: true, allowsFraction: false, priceCents: 1000 }) });
