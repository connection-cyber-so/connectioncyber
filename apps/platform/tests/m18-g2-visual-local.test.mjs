...
test('RPCs mestres permanecem habilitadas após evolução do transporte',()=>{assert.match(local,/erp_command_create_party_v1/);assert.match(local,/erp_command_create_catalog_item_v1/);assert.match(local,/command unavailable in M18-G4/);});
