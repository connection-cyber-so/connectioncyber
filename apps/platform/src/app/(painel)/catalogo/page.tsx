import '@/styles/cc-classic.css';import { listVisualCatalogItems,listVisualUnits,listVisualItemFiscalData,listVisualItemCommercialData,listVisualBusinessVerticals,listVisualVerticalAttributeRequirements,listVisualEstablishments,visualPersistenceMode } from '@/features/persistence/selected';import { ItemForm } from '@/features/catalog/components/CatalogForms';import { CatalogList } from '@/features/catalog/components/CatalogList';import { EstablishmentSwitcher } from '@/components/EstablishmentSwitcher';import { getSelectedEstablishmentId } from '@/lib/establishment-scope';import { CadastroSwitchBar } from '@/components/CadastroSwitchBar';
...
export default async function CatalogoPage(){
  ...
  return <div className="cc-classic"><div className="window"><div className="header-bar"><div className="header-title"><div className="eyebrow">ConnectionCyber · Cadastros ERP</div><h1>Cadastro de produto</h1></div><CadastroSwitchBar active="produto"/><span className="spacer"></span><span className="pill">{items.length} item(ns)</span></div>
  <div className="body">
