...
if exists(select 1 from public.erp_permissions where key in('import.read','import.audit')and category<>'Importacao')then raise exception 'M14 permission collision';end if;
end$$;
