...
drop function if exists public.erp_revoke_remote_access(uuid,uuid,text,text),public.erp_issue_remote_access_grant(uuid,uuid,uuid,uuid,text[],text,text),public.erp_create_support_ticket(uuid,uuid,uuid,text,text,text,text,text,text);
